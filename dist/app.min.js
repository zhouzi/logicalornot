	...
	var GameClass = (function () {
	  ...
	  _createClass(GameClass, [{
	    ...
	    value: function bind() {
	      ...
	      this.stream.subscribe('new question', function (newQuestion) {
	        ...
	        _this.newRound();
	      }).subscribe('answer question', function (isCorrect, nextQuestion) {}).subscribe('view:selectAnswer', function (answer) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _cancelAnimationFrame = __webpack_require__(8);

	var _cancelAnimationFrame2 = _interopRequireWildcard(_cancelAnimationFrame);

	var _rand = __webpack_require__(9);
	...
	var GAP = 1; // lose or win 1 second
	...
	var RoundClass = (function () {
	  ...
	  _createClass(RoundClass, [{
	    ...
	    value: function riseLifeBar() {
	      if (this.config.iteration - this.config.gap <= 0) this.config.iteration = 0;else this.config.iteration -= this.config.gap;
	    }
	  }, {
	    key: 'dropLifeBar',
	    value: function dropLifeBar() {
	      if (this.config.iteration + this.config.gap >= this.config.totalIterations) this.config.iteration = this.config.totalIterations;else this.config.iteration += this.config.gap;
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SELECTANSWER = 'view:selectAnswer';
	var NEWROUND = 'view:newRound';
